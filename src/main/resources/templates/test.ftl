...
<header class="clearfix">
    <div class="container">
        <a id="logo" href="test.ftl">Поиск Фильмов</a>
        ...
        <nav class="clearfix">
            <ul role="navigation">
                <li>
                    <a href="/index" class="activePage"><span class="icon">S</span>Главная</a>
                </li>
                <li>
        ...
        <article>
            <figure>
                ...
                <figcaption>
                    ...
                    <p>Pellentesque mi arcu, sollicitudin vel malesu, <a href="#">volutpat vitae nisi.</a> Nulla luctus
                        lacus at tortor blandit semper. Donec gravida aliquet urna, eu pulvinar ligula pellentesque
                        ornare. <a href="#" class="more-link">Read more &rarr;</a></p>
                </figcaption>
            </figure>
        </article>
    </div>
    <div class="columns">
        <article>
            <figure>
                ...
                <figcaption>
                    <h3>Responsive</h3>
                    <p>Pellentesque mi arcu, sollicitudin vel malesu, volutpat vitae nisi. Nulla luctus lacus at tortor
                        blandit semper. Donec gravida aliquet urna, eu pulvinar ligula pellentesque ornare. <a href="#"
    ...
    <div class="columns">
        <article>
            <figure>
                ...
                <figcaption>
                    <h3>Pure CSS3</h3>
                    <p>Pellentesque mi arcu, sollicitudin vel malesu, <strong>volutpat vitae nisi. Nulla luctus</strong>
                        lacus at tortor blandit semper. Donec gravida aliquet urna, eu pulvinar ligula pellentesque
                        ornare. <a href="#" class="more-link">Read more &rarr;</a></p>
                </figcaption>
            </figure>
...
<footer role="contentinfo">
    <p>
        ...
        <a href="test.ftl">HOME</a> | <a href="portfolio.html">PORTFOLIO</a> | <a href="page.html">PAGE</a> | <a
